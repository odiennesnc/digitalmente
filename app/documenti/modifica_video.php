...
// Verifica che sia effettivamente un video/documentario
if ($documento['tipologia_doc'] != 3) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        // Prepara i parametri per il video/documentario
        $params = [
            'id' => $document_id,
            'titolo' => $titolo,
            ...
            'regia' => cleanData(isset($_POST['regia']) ? $_POST['regia'] : ''),
            'montaggio' => cleanData(isset($_POST['montaggio']) ? $_POST['montaggio'] : ''),
            'argomento_trattato' => cleanData(isset($_POST['argomento_trattato']) ? $_POST['argomento_trattato'] : '')
        ];
        
        // Aggiornamento nel database
        if (updateDocument($conn, $params)) {
            $message = "Video/documentario aggiornato con successo";
            $messageType = 'success';
            ...
            $message = "Errore durante l'aggiornamento del video/documentario";
            $messageType = 'error';
        }
    } else {
...
<div class="container px-6 mx-auto grid">
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form action="modifica_video.php?id=<?php echo $document_id; ?>" method="POST" enctype="multipart/form-data">
                ...
                <!-- Campi specifici per i video/documentari -->
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="regia" name="regia" value="<?php echo htmlspecialchars(isset($documento['regia']) ? $documento['regia'] : ''); ?>" 
                           class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="montaggio" name="montaggio" value="<?php echo htmlspecialchars(isset($documento['montaggio']) ? $documento['montaggio'] : ''); ?>" 
                           class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input">
                </div>
